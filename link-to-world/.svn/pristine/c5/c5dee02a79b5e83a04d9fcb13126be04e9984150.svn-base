 ...
 * @author miller
 */
public class MarriageTypeFieldProvider extends DefaultFieldProvider {
    private final EnumMarriageTypeWebServiceClient enumMarriageTypeWebService;

    public MarriageTypeFieldProvider(String groupName, String fieldName, FormConfig formConfig, InsuranceFormGroupWebService insuranceFormGroupWebService, InsuranceFormFieldWebService insuranceFormFieldWebService, EnumMarriageTypeWebServiceClient enumMarriageTypeWebService) {
    ...
    protected Map<String, Object> options(FormContext form, InsuranceFormFieldResponse insuranceFormField, ProductFormField productFormField) {
        ...
        if (!options.containsKey("constants")) {
            ...
            enumMarriageTypeWebService.findAll().list.forEach(type -> {
