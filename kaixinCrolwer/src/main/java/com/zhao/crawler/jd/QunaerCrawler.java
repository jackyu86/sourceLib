 ...
 * @date 2015-10-20
 */
public class QunaerCrawler extends ECCrawler {
	 ...
	 * @param seekFormat
	 */
	public QunaerCrawler(String crawlPath, String seekFormat) {
...
//		return ele==null?0:Integer.parseInt(ele.text());
	...
	public static void main(String[] args) throws Exception {
		...
		String url ="https://bao.qunar.com/auto/price?carNo=%e9%97%bdD926BX";
	//	JDCrawler crawler=new JDCrawler("c:/nevi/test/crawler/jd/", "http://list.jd.com/list.html?cat=1319,1523,7052&page=%s&go=0&JL=6_0_0");
		QunaerCrawler crawler=new QunaerCrawler("c:/nevi/test/crawler/jd/", url);
