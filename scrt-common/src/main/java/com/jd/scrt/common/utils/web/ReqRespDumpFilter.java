...
public class ReqRespDumpFilter implements Filter {
	...
	private static final Log logger = LogFactory.getLog(ReqRespDumpFilter.class);
	...
	public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException,
		...
		try {
			...
			final StringBuilder logMessage = new StringBuilder("MVC Request - ").append("[HTTP METHOD:")
					...
					.append(httpServletRequest.getRemoteAddr()).append("]").append(" [HEADERS: ")
					.append(getAllHeadersStr(bufferedReqest)).append("]");
			...
			if(!httpServletRequest.getPathInfo().startsWith("/resources"))
	...
	public String getAllHeadersStr(HttpServletRequest request) {
		String str = "";
