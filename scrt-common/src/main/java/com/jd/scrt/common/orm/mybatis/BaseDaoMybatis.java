 ...
 * @since 1.0.0
 */
public abstract class BaseDaoMybatis {

    private static final Logger logger = Logger.getLogger(BaseDaoMybatis.class);
    ...
    protected Map selectMap(String statement, Object parameter, String mapKey) throws Exception {
        if (logger.isDebugEnabled()) {
     ...
     */
    @SuppressWarnings("rawtypes")
    protected List selectList(String statement, Object parameter) throws Exception {
        if (logger.isDebugEnabled()) {
     ...
     */
    @SuppressWarnings("rawtypes")
    protected Object selectFirst(String statement, Object parameter) throws Exception {
        if (logger.isDebugEnabled()) {
     ...
     */
    @SuppressWarnings("rawtypes")
    protected List selectList(String statement, Object parameter, int offset, int rows) throws Exception {
        if (logger.isDebugEnabled()) {
    ...
    protected <T> Page<T> selectList(String statement, Object parameter, Page<T> page) throws Exception {
        List<T> lists = this.selectList(statement, parameter, page.getOffset(), page.getPageSize());
     ...
     * @throws Exception
     */
    protected int selectCount(String statement, Object parameter) throws Exception {
        if (logger.isDebugEnabled()) {
